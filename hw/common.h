...
struct hw_info_t {
	...
	uint32_t reserved[9];
	/* open device */
	int (*open)(struct hw_info_t *info, struct hw_common_t **common);
};
...
/**
 * Version of the struct hw_info_t
 */
 ...
 */
#define HARDWARE_INFO_SYM		THI

/**
 * Name of the hardware info symbolic as a string
 */
#define HARDWARE_INFO_SYM_AS_STR	"THI"
