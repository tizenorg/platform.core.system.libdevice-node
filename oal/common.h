...
#ifndef __OAL_COMMON_H__
#define __OAL_COMMON_H__
...
/**
 * Name of the oal_device_info (Tizen Oal Device)
 */
#define OAL_DEVICE_INFO_SYM		TOD

/**
 * Name of the oal_device_info as a string
 */
#define OAL_DEVICE_INFO_SYM_AS_STR	"TOD"
